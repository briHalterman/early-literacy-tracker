...
#### Acceptance Criteria
- Given that I am on the login/register page, when I enter a valid email and password, then my account is created.
...
#### Acceptance Criteria
- Given that I am on the login/register page, when I enter correct credentials and submit the form, then I am redirected to my reading log.
...
- Given that I am logged in, when I click the Logout button, then I am redirected to the login/register page.
- Given that I am not logged in, when I click the Logout button, then I am redirected to the login/register page.
...
- Given a missing title, when I submit the form, then I see an error message.
...
- Given that I am not logged in, when I navigate to the create log entry page, then I am redirected to the login/register page.
- Given that I am not logged in, when I submit the form, then I am redirected to the login/register page.
...
- Given that I am not logged in, when I navigate to my reading log page, then I am redirected to the login/register page.
...
- Given that I am not logged in, when I navigate to a log entry's page, then I am redirected to the login/register page.
...
#### Acceptance Criteria
- Given that I am on a log entry's edit page, when I enter updates to my log entry, valid title included, then the log entry is changed to include the updated details.
- Given a missing title, when I submit the form, then I see an error message.
...
- Given that I am not logged in, when I navigate to a log entry's edit page, then I am redirected to the login/register page.
- Given that I am not logged in, when I submit the form, then I am redirected to the login/register page.
...
- Given that I am not logged in, when I click the Delete button, then I am redirected to the login/register page.
...
**As a logged-in user, I want to search for books so that I can autofill the details of a new reading log entry.**

#### Acceptance Criteria
- Given that I enter a search term, when I click the Search button, then I see a list of matching books.
- Given an empty search, when I click the Search button, then I see an error message.
- Given that I enter a search that yields no matches, when I click the Search button, then I see a message.
- Given that I select a search result, when I click the book, then I am redirected to the create log entry page.
